...
class Article(models.Model):
    ...
    first_child = models.ForeignKey('Comment', null=True, on_delete=models.CASCADE, related_name='article_first_child')
    last_child = models.ForeignKey('Comment', null=True, on_delete=models.CASCADE, related_name='article_last_child')
...
class Comment(models.Model):
    ...
    sibling_prev = models.ForeignKey('Comment', null=True, on_delete=models.CASCADE, related_name='comment_prev_sib')
    sibling_next = models.ForeignKey('Comment', null=True, on_delete=models.CASCADE, related_name='comment_next_sib')
    first_child = models.ForeignKey('Comment', null=True, on_delete=models.CASCADE, related_name='comment_first_child')
    last_child = models.ForeignKey('Comment', null=True, on_delete=models.CASCADE, related_name='comment_last_child')
